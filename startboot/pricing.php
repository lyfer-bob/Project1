                ...
                <div class="col-lg-12">
                    ...
                    <?php
                                                     ...
                                                     if($rs->num_rows > 0)
                                                     {
                                                      ...
                                                      echo "<th>ความคืบหน้า</th>";
                                                      echo "<th>เบอร์โทรศัพท์</th>";
                                                      echo "<th>ชื่อ - สกุล</th>";
                                                      echo "<th>แก้ไข</th>";
                                                      echo "<th>พิมพ์รายละเอียด</th>";
                                                      echo "</tr>";
                                                      echo "</thead>";
                                                      echo "<tbody>";
                                      ...
                                      echo "    <td class='center'><a href='editpro.php?name=".$row["name"]."'>แก้ไขโครงการ</td>";
                                      echo "    <td class='center'><a href='printpro.php?name=".$row["name"]."'><center>พิมพ์</center></td>";
