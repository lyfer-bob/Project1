...
$sql = "SELECT COUNT(progress) AS COUNTTB,status FROM project WHERE progress >=50 and status = 'กำลังดำเนินการ'";
$sql1 = "SELECT COUNT(progress) AS COUNTTB,status FROM project WHERE progress >=50 and status = 'เสร็จแล้ว'";
$sql2 = "SELECT COUNT(progress) AS COUNTTB,status FROM project WHERE progress >=50 and status = 'ล่าช้า'";
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'เปอร์เซนต์โครงการที่เสร็จมากกว่า 50%'
        },
        tooltip: {
